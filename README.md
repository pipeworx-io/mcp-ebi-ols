...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/list_ontologies \
  -H 'Content-Type: application/json' \
  -d '{"size":20,"page":0}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/list_ontologies`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
